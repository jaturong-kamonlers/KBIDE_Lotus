module.exports = function(Blockly) {
  ...
  Blockly.Blocks['button_1_status'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("/static/icons/rail.png", 20, 20, "*"))
  ...
  Blockly.Blocks['TCS_read_rgb'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("/static/icons/color.png", 20, 20, "*"))
  ...
  Blockly.Blocks['WIT_beep'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("/static/icons/buzzer.png", 20, 20, "*"))
  ...
  Blockly.Blocks['bmp280_begin'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("/static/icons/bmp280.png", 20, 20, "*"))
  ...
  Blockly.Blocks['bmp280_read_temperature'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("/static/icons/temp.png", 20, 20, "*"))
  ...
  Blockly.Blocks['bmp280_read_pressure'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("/static/icons/pressure.png", 20, 20, "*"))
  ...
  Blockly.Blocks['bmp280_read_altitude'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("/static/icons/altitude.png", 20, 20, "*"))
  ...
  Blockly.Blocks['mlx90614_begin'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("/static/icons/mlx90614.png", 20, 20, "*"))
  ...
  Blockly.Blocks['mlx90614_read_object'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("/static/icons/temp_ir.png", 20, 20, "*"))
